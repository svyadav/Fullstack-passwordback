...
const ClientUrl="https://aquamarine-wisp-e67a11.netlify.app"
  ...
  try{
    ...
    if(setusertoken){
      const mailOptions={
        ...
        text:`This link is valid for two minutes ${ClientUrl}/forgetpassword/${userFind.id}/${setusertoken.verifyToken}`
      }
